  ...
  <div class="d-flex align-center mb-6">
    <div>
      <div class="d-flex align-center gap-2 mb-1">
        <v-icon icon="fas fa-message" color="primary" size="28" />
        <h1 class="text-h5 font-weight-black text-primary px-2">إدارة رسائل الرفض</h1>
      </div>
...
const headers = [
  { title: 'نوع الرسالة', key: 'messageType', align: 'center' },
  { title: 'رسالة الرفض', key: 'message', align: 'center' },
...
function doDelete() {
  ...
  showSnackbar('تم حذف رسالة الرفض', 'error')
