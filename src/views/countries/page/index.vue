    ...
    <div class="d-flex align-center mb-6">
      <div>
        <div class="d-flex align-center gap-2 mb-1">
          <v-icon icon="fas fa-earth" color="primary" size="28" />
          <h1 class="text-h5 font-weight-black text-primary px-2">إدارة الدول</h1>
        </div>
...
const headers = [
  { title: 'رمز الدولة', key: 'code', align: 'center' },
  { title: 'اسم الدولة', key: 'name', align: 'center' },
  { title: 'عدد المدن', key: 'citiesCount', align: 'center' },
...
function doDelete() {
  ...
  showSnackbar('تم حذف الدولة', 'error')
