  ...
  <div class="d-flex align-center mb-6">
    <div>
      <div class="d-flex align-center gap-2 mb-1">
        <v-icon icon="fas fa-flag" color="primary" size="28" />
        <h1 class="text-h5 font-weight-black text-primary px-2">إدارة الجنسيات</h1>
      </div>
...
import { useNationalitiesStore } from '@/stores/index.js'
...
const headers = [
  { title: 'رقم الجنسية', key: 'nationalityNumber', align: 'center' },
  { title: 'اسم الجنسية', key: 'name', align: 'center' },
  { title: 'الدولة', key: 'countryName', align: 'center' },
...
function doDelete() {
  ...
  showSnackbar('تم حذف الجنسية', 'error')
